...
return [
    ...
    'views' => [
        ...
        'header' => 'view-components::general.header',
        'header-history-item' => 'view-components::general.header-history-item',
        'header-notification-item' => 'view-components::general.header-notification-item',
        'header-notifications' => 'view-components::general.header-notifications',
        'header-search' => 'view-components::general.header-search',
        'header-search-item' => 'view-components::general.header-search-item',
