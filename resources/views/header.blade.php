            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    <button
                        ...
                        :aria-expanded="open"
                    >
                        <img class="w-8 h-8 rounded-full" src="/img/avatar_m.png" width="32" height="32" alt="User" />
                    ...
                    >
                        ...
                        <ul>
                            <li>
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3" href="{{ route('logout') }}">Logout</a>
                            </li>
                        </ul>
                    </div>
                </div>
